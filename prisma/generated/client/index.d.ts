...
export namespace Prisma {
  ...
  */
   ...
   * UserCountOutputType without action
   */
  export type UserCountOutputTypeCountVideosArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetOmit<'id' | 'createdAt' | 'email' | 'name' | 'role', ExtArgs['result']['user']>;
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    videos<T extends User$videosArgs<ExtArgs> = {}>(
      args?: Subset<T, User$videosArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'findMany', GlobalOmitOptions> | Null
    >;
    /**
  ...
  export type VideoSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetSelect<
      {
        id?: boolean;
        createdAt?: boolean;
  ...
  export type VideoOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetOmit<
      | 'id'
      | 'createdAt'
      | 'title'
  ...
  > {
    ...
    findUnique<T extends VideoFindUniqueArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'findUnique', GlobalOmitOptions> | null,
      null,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    findUniqueOrThrow<T extends VideoFindUniqueOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'findUniqueOrThrow', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    findFirst<T extends VideoFindFirstArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'findFirst', GlobalOmitOptions> | null,
      null,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    findFirstOrThrow<T extends VideoFindFirstOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'findFirstOrThrow', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    findMany<T extends VideoFindManyArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'findMany', GlobalOmitOptions>
    >;
    ...
    create<T extends VideoCreateArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'create', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    createManyAndReturn<T extends VideoCreateManyAndReturnArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'createManyAndReturn', GlobalOmitOptions>
    >;
    ...
    delete<T extends VideoDeleteArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'delete', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    update<T extends VideoUpdateArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'update', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    updateManyAndReturn<T extends VideoUpdateManyAndReturnArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'updateManyAndReturn', GlobalOmitOptions>
    >;
    ...
    upsert<T extends VideoUpsertArgs>(
      ...
      $Result.GetResult<Prisma.$VideoPayload<ExtArgs>, T, 'upsert', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
  ...
  export type VideoUpdateManyWithoutUserNestedInput = {
    ...
    update?:
      ...
      | VideoUpdateWithWhereUniqueWithoutUserInput[];
    updateMany?:
      | VideoUpdateManyWithWhereWithoutUserInput
      | VideoUpdateManyWithWhereWithoutUserInput[];
  ...
  export type UserUpdateOneRequiredWithoutVideosNestedInput = {
    ...
    connect?: UserWhereUniqueInput;
    update?: XOR<
      XOR<UserUpdateToOneWithWhereWithoutVideosInput, UserUpdateWithoutVideosInput>,
